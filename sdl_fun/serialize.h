void _gameSerialize(Serialize* game, FILE* file) {
...
int _gameDeserialize(Serialize* game, FILE* file) {
   //   GameWindow* sdl = nullptr;
   //   Vector<Board*>* boards = nullptr;
   //   Resources* resources = nullptr;
...
void _boardSerialize(Serialize* board, FILE* file) {
...
int _boardDeserialize(Serialize* board, FILE* file) {
